...
export default function Login() {
  ...
  return (
    ...
    >
      {/* Animated orbs */}
      <div
        className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full opacity-30 animate-float"
        style={{ background: 'radial-gradient(circle, #7c3aed 0%, transparent 70%)' }}
      />
      <div
        className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full opacity-20 animate-float-delay"
        style={{ background: 'radial-gradient(circle, #4c1d95 0%, transparent 70%)' }}
      />
      <div
        className="absolute top-[40%] right-[20%] w-[300px] h-[300px] rounded-full opacity-10 animate-pulse-slow"
      ...
      <div className="relative z-10 w-full max-w-md px-4 animate-slide-up">
        <div className="glass rounded-3xl p-8 glow-purple">
          ...
          <p className="text-slate-400 text-sm mb-8">Sign in to your analytics dashboard</p>
